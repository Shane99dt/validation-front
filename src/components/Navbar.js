      ...
      <nav className="p-5 bg-stone-100 shadow md:flex md:items-center md:justify-between text-gray-800 font-medium">
        ...
        ${clicked ? ('z-30 pl-7 py-4 fixed bg-gray-800/80'):('opacity-0 top-[-400px] z-[-1] absolute')}
          ...
          <li className="mx-4 my-2 md:my-0">
            <Link to='/' className=" hover:text-zinc-500 duration-500">HOME</Link>
          </li>
          <li className="mx-4 my-2 md:my-0">
            <Link to='/users' className=" hover:text-zinc-500 duration-500">Users</Link>
          </li>
          <li className="mx-4 my-2 md:my-0">
            <Link to='/new-user' className=" hover:text-zinc-500 duration-500">New user</Link>
          </li>
        </ul>
      </nav>
    </>
